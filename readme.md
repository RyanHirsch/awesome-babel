...
### General Plugins
 ...
 - [transform-decorators-legacy](https://github.com/loganfsmyth/babel-plugin-transform-decorators-legacy) - Restores Babel 5 decorator output. Caution: Decorators are very likely to change.
 - [undeclared-variables-check](https://github.com/babel/babel/tree/master/packages/babel-plugin-undeclared-variables-check) - Throws a compile-time error on references to undeclared variables.
